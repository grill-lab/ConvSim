...
class GPT3AnswerCQ(AbstractAnswerCQ, AbstractTransformer):
    ...
    def answer_cq(
        self, information_need: str, history: List[str],
        current_user_turn: str,
        current_system_response: str
    ) -> str:
        prompt = self.create_prompt(
            information_need, history, current_user_turn,
            current_system_response
        )
        print(prompt)
    ...
    @staticmethod
    def create_prompt(
        information_need: str, history: List[str], current_user_turn: str,
        current_system_response: str
    ) -> str:
